...
public class ExpandListViewAdapter extends BaseExpandableListAdapter {
    ...
    public ExpandListViewAdapter(Context context, List<String> childParent, HashMap<String, List<String>> child) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if(view == null){
            ...
            view = inflater.inflate(R.layout.expandparent_layout, parent, false);

        }

        String parentHeader = (String)getGroup(groupPosition);

        TextView parentItem = (TextView)view.findViewById(R.id.expandparent_layout);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if(view == null){
            ...
            view = inflater.inflate(R.layout.expandchild_layout, parent, false);

        }

        String childName = (String)getChild(groupPosition, childPosition);

        TextView childItem = (TextView)view.findViewById(R.id.expandchild_layout);
